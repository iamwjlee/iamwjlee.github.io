...
const copyMe = true
```
[한글님의 coa 스톰위버](https://www.youtube.com/watch?v=uezHwK2Knyk)
1. 2번무기로 권능충전,1번무기로 권능 소모 

[아르의 소환 바라시타](https://www.youtube.com/watch?v=QEqUIHQjRyY&t=342s)
1. 1차전직 나비라의파열(얼음지대를 파열시켜)
    - 서리폭탄: 기폭시간 4초 -> 너무느림
    - 짧은퓨즈: 기폭시간 2.4초 -> 여전히 느림
    - 짧은퓨즈2: 기폭시간 0.8초 -> 액트4장에서 획득가능
    - 그래서 액트4장까지 '정수흡수'유지 또는
    - 그래도 해보겠다 하면: 해골서리마법사 + 서리연결부 보조젬
    - 해골서리마법사 세팅
        - 해골서리마법사 - 서리연결부-다중사격2
        - 나비라의파열 - 서리연결부-지시1
        - 서리폭탄 - 과잉1-주문메아리
        - 얼음폭발 - 범위확대2-우주의영사
        - 원소약화 - 고조된저주-집중된저주
    - 해골서리마법사가 몬스터를 동결시키면 '얼음지대'가 생성
    - 생성된 얼음지대위에 '나비라의파열'을 사용하여 무리 정리
    - 마법사의 동결만으로 부족할경우,서리폭탄->얼음폭발을 직접 시전해 얼음지대를 마든다.
...
3. 태풍파열볼트: 빠른공격2,근접전투2,원소병기2,범위집중,리그월드의 흉포함
4. 얼음의전령: 범위확대,원소집중,살을에는서리,치명적인전령,원소병기
5. 재의전령: 범위확대,신랄
6. 천둥의전령: **원소집중**,**원소병기2**,번개숙련,살아있는번개,원거리사격
7. 영원한격노(정신력100): 격노 재생 알아봐!!!
8. 바람의무희:힘줄절단,실명,생명력흡수,원소병기
9. 전도성유탄(냉기피해로 사용): 혹독,동결,다중사격2,짧은퓨즈2,바타이르의 복수
10. 전도성징표: 지속시간연장,효율,생명력전환,죽음의징표

[밈찬 의 런앤건 스타일의 시원한 맵핑초기단계의 빌드업](https://www.youtube.com/watch?v=bAaGNcG2_rg)
1. 스타터때 사용하는 유탄은 딜레이가 존재 강력하지만 호불호
2. 맵핑단계에서는 **충격파편** 사용 빠르게,보스는 감파탄과 플라스마를 사용 
3. 패시브스킬 : 2:45
4. 물리DPS 500~600,주얼은 에메랄드(감전강도,석궁재장전,석궁사용시 공속...)
3. 스킬
    - **충격파편** : 번개조율,갈래,감전,번개노출
    - **감전파열탄환** : 빠른공격2,새탄창2,원소병기2,원소집중
    - **플라스마폭발**(보스전 오프닝 스킬) : 암브로시아,원소병기2,급성장2
    - **비상재장전**(사용해야 보스전에서 감전시간동안 2탄창을 비울수 있다)  : 재사용대기시간회복2,생명력전환,지속시간연장2
    - **천둥의전령** : **원소집중**,**원소병기2**,번개조율,질러뻗기 / 번개숙련,살아있는번개,원거리사격
4. 보스전
    - 루틴이 짧은보스는 충격파편으로 감전을 걸고 감파탄 박아(활을 이용해서 감전을 거는 방법도)
    - 루틴이 긴보스는 플라스마를 한대 박고 감파탄 쫙 박아    

[저먼스플랙스의쇠뇌 머서너리 폭발성사격 스타터](https://www.youtube.com/watch?v=pZ7Nez2hKV8)
1. 1장 스킬구성
    - 파편탄환 - 무도의속도
    - 영구결빙볼트 - 관통/얼음쐐기
    - 폭발유탄 - 신속처리/화염주입
...
2. 2장 스킬구성
    ...
    - 바람의 무희 - 바람의파장
3. 최종 캠페인 스킬
    - 폭발성사격 - 무도의속도/난사/화염주입/자동재장전(보스는 효과집중으로 교체)
    - 기름유탄 - 지속성/과도한노출/화염노출
    - 절단선 쇠뇌 - 선대의다급함/페쇄
    - 비상 재장전 - 기발함/모의
    - 바람의 무희 - 바람의 파장/실명
...
[웅키둥키의 위치헌터 태풍파열볼트](https://www.youtube.com/watch?v=nVPmXIbDA4A)
1. 천둥의전령 : 원소병기,전기처형,원거리사격
2. 재의전령 : 범위확대
2. 태풍파열볼트 : 빠른공격,범위집중,원소병기,번개조율
3. 전도성유탄(보스용) : 다중사격,원소병기,접착유탄
4. 전도성징표(보스용) : 지속시간연장,충전된 징표
5. 고유장갑(발라코의 악덕,렙45) : 화염피해의 100%를 번개피해로 전환 
6. 보스용 무기셋트 패시브스킬: 태풍파열볼트

[저먼의 유탄빌드](https://www.youtube.com/watch?v=dfa1-MXNndY)
1. 유탄의 기본운영-무빙샷 & 구르기활용
    - 빠른 몬스터 상대법 - 역방향 투척
    - 섬광 유탄(넓은 피해,즉시폭발)- 보조젬 '고정'(실명)활용 
    - 유탄빌드는 폭발유탄이나 소이사격을 통해 몬스터에게 점화 디버프를 쉽게 걸 수 있다
    - 15렙에 가스유탄은 점화상태의 대상에게 던지면 3초의 기폭시간없이 즉시 폭발
    - 점화와 가스유탄의 연계 (소이사격+가스유탄)시 즉시 피해 
    - 22렙부터 사용가능한 폭발성 사격스킬로 유탄+폭발성사격 - 원하는 타이밍에 즉시 기폭
        - 집속폭탄노드 사용하여 리스크없이 투사체 1개 추가 발사
    - 사격,유탄 보조젬
        - 소이사격: 관통/원소병기
        - 폭발성사격: 다중사격/더블배럴/원소병기
        - 폭발유탄: 다중사격/범위확대/원소병기
        - 섬광유탄: 다중사격/고정
        - 가스유탄: 원소병기/범위집중/처형

[스폰서의 데드아이 폭발유탄](https://www.youtube.com/watch?v=gKcHGtcMkNY)
0. 패시브 스킬트리 : 12:36

1. 액트1
    - 스킬젬1레벨: 폭발유탄,전염
    - 스킬젬3레벨: 서리폭탄
    - 지오너백작 진입전에 14레벨 가스유탄
3. 액트2 
    - 7레벨스킬잼에서 폭발유탄
    - 9레벨 기름유탄
    - 전직
...
4. 액트3 
    - 포격석궁(33렙) 구하기 
5. 액트4이후
    - 11렙 박격포 대포받기(무기2번으로 셋팅) ,  유탄-다중사격연결
    - 13렙 집속유탄 받기 : 박격포 대포 - 집속유탄 -화물 -긴급한토템3
    - 연속포격석궁(레벨58) 구하기  
