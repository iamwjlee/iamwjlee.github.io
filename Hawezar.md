...
### Diablo 4 Necromancer
  하수인+본체 공격속도 100퍼 - 이교우두머리 전설노드 효과를 모드 받기위해,핵심지속효과(칼란의 칙령,하수인하나당 공속 3%)
    하수인 10명 공속 30% 확인해봐!
    하수인 공속 담금질도 한부위 해줘야
  만약 칼린의 칙령없이 공속 100%가 된다면 핵심지속은 그림자 마름병으로     



  그늘안개 위상 - 하수인이 주위의 적에게 초당 38의 암흑피해,지속피해는 오라를 벗어난뒤 2~5초간 지속
  그림자마름병위상 - 핵심지속효과가 적에게 10번 피해를 준후 6초 동안 피해 50% 증가 - 그늘안개위상으로 상시 발동

  모자와 신발에 초당정수 챙겨야 - 대향연(양손낫이나 목걸이에) 위상땜에
  공속100퍼 캡안되면 
    수동저주,마름병 철관 포인트 빼야
    노화넣고  무광사용
    그늘안개대신 광분한 망자의 위상(하수인공속 증가)사용
    저주받은 오라 대신 무광(해골전사가 암흑피해)사용
    수동저주와 해골학자 어둠변경으로 마름병 충첩쌓기

    마름병이란? 역병투사체를 발사하여 착탄지점에 도트딜 장판을 만든다.
    마름병걸린시체폭발: 시폭이 1회성이 아닌 어둠속성을 지닌 장판스킬이 된다. 어둠패시브와 조합 
    핵심지속효과의 그림자 마름병은 암흑피해가 적에게 2초간 그림자마름병을 감염,및 추가피해
